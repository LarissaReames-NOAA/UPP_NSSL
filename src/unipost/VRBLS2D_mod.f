...
! GSD addition
      ,WSPD10MAX(:,:),WIND02MAX(:,:),SPD02INTMAX(:,:)                        &
      ,W_UP_MAX(:,:),W_DN_MAX(:,:),REFD_MAX(:,:)                             &
      ,UP_HELI_MAX(:,:),UP_HELI_MAX16(:,:),GRPL_MAX(:,:),QRMAX(:,:)          &
      ,UP_HELI(:,:),UP_HELI16(:,:),LTG1_MAX(:,:),LTG2_MAX(:,:),LTG3_MAX(:,:) &
      ,UP_HELI_MIN(:,:),UP_HELI_MIN16(:,:)                                   &
      ,UP_HELI_MAX0_05(:,:),UP_HELI_MIN0_05(:,:)                             &
      ,UP_HELI_MAX01(:,:),UP_HELI_MIN01(:,:)                                 &
      ,UP_HELI_MAX05_15(:,:),UP_HELI_MIN05_15(:,:)                           &
      ,UP_HELI_MAX0_15(:,:),UP_HELI_MIN0_15(:,:)                             &
