...
!     increase MXFLD each time you add a new field
      INTEGER, PARAMETER :: MXFLD=957,MXLVL=70
...
! SRD
     ...
     &                      /1,'HAILCAST DIAM MAX   ',246,200,     &
     &                       'HAILCASTMAX ON entire_atmos_single_lyr'/     !930
! SRD
! CRA
...
! SRD
      DATA IFILV(790),AVBL(790),IQ(790),IS(790),AVBLGRB2(790)      &
     &                      /1,'MAX UPDR HELICITY03 ',216,106,     &
     &                         'MAX UPDR HELICITY03 '/
! KHK
      DATA IFILV(935),AVBL(935),IQ(935),IS(935),AVBLGRB2(935)      &
     &                      /1,'MAX UPDR HELICITY005 ',216,106,    &
     &                         'MAX UPDR HELICITY005 '/
      DATA IFILV(936),AVBL(936),IQ(936),IS(936),AVBLGRB2(936)      &
     &                      /1,'MAX UPDR HELICITY01 ',216,106,     &
     &                         'MAX UPDR HELICITY01 '/
      DATA IFILV(937),AVBL(937),IQ(937),IS(937),AVBLGRB2(937)      &
     &                      /1,'MAX UPDR HELICITY015 ',216,106,    &
     &                         'MAX UPDR HELICITY015 '/
      DATA IFILV(788),AVBL(788),IQ(788),IS(788),AVBLGRB2(788)      &
     &                      /1,'MAX UPDR HELICITY02 ',216,106,     &
     &                         'MAX UPDR HELICITY02 '/
     DATA IFILV(943),AVBL(943),IQ(943),IS(943),AVBLGRB2(943)       &
     &                      /1,'MAX CONV WIND ',217,106,           &
     &                 'MAX CONV WIND ON spec_hgt_lvl_above_grnd'/
     DATA IFILV(944),AVBL(944),IQ(944),IS(944),AVBLGRB2(944)       &
     &                      /1,'MAX INT CONV WIND ',218,106,       &
     &             'MAX INT CONV WIND ON spec_hgt_lvl_above_grnd'/
! SRD
