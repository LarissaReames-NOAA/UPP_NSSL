...
! SRD
      ...
      allocate(wind02max(im,jsta_2l:jend_2u))
      allocate(spd02intmax(im,jsta_2l:jend_2u))
      ...
      allocate(up_heli_max0_05(im,jsta_2l:jend_2u))
      allocate(up_heli_min0_05(im,jsta_2l:jend_2u))
      allocate(up_heli_max01(im,jsta_2l:jend_2u))
      allocate(up_heli_min01(im,jsta_2l:jend_2u))
      allocate(up_heli_max05_15(im,jsta_2l:jend_2u))
      allocate(up_heli_min05_15(im,jsta_2l:jend_2u))
      allocate(up_heli_max0_15(im,jsta_2l:jend_2u))
      allocate(up_heli_min0_15(im,jsta_2l:jend_2u))
...
! CRA
      ...
      allocate(tsfcin(im,jsta_2l:jend_2u))
      allocate(psfcin(im,jsta_2l:jend_2u))
      allocate(t2min(im,jsta_2l:jend_2u))
