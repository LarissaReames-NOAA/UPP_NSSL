...
!
      ...
      deallocate(pd)
      deallocate(mxsnal)
      deallocate(tsfcin,psfcin,t2min)
! add GFS fields
      deallocate(sfcux)
      deallocate(sfcvx)
...
! SRD
      ...
      deallocate(wind02max)
      deallocate(spd02intmax)
      deallocate(w_up_max)
      deallocate(w_dn_max)
      deallocate(w_mean)
      deallocate(refd_max)
      ...
      deallocate(up_heli_max0_05)
      deallocate(up_heli_min0_05)
      deallocate(up_heli_max01)
      deallocate(up_heli_min01)
      deallocate(up_heli_max05_15)
      deallocate(up_heli_min05_15)
      deallocate(up_heli_max0_15)
      deallocate(up_heli_min0_15)
